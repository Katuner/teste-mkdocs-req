...
| Solução | Gamificação | Alerta Preditivo | Foco em Aprendizes | Integração Setor Transporte |
|---------|:-----------:|:----------------:|:------------------:|:---------------------------:|
| Ludos Pro | ✅ | ❌ | ❌ | ❌ |
| Feedz (TOTVS) | ✅ | ❌ | ❌ | ❌ |
| Niduu (Gupy) | Parcial | ❌ | ❌ | ❌ |
...
A viabilidade técnica da proposta é considerada **alta**, uma vez que a equipe possui experiência prévia com as tecnologias selecionadas. O escopo do MVP foi deliberadamente delimitado para ser entregável dentro do prazo do semestre letivo, priorizando as características de maior impacto (C1, C3 e C5).
